...
|-----------|--------|-------------|
| `FrameBuffer(width, height)` | `FrameBuffer` | Make a new FrameBuffer of the provided size |
...
### `FrameBuffer(width: integer, height: integer): FrameBuffer`

Make a new FrameBuffer of the provided size

#### Parameters
- `width: integer` - Width of the new frame buffer
- `height: integer` - Height of the new frame buffer
